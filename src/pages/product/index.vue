 ...
 *
 * You will be able to access this page at http://localhost:8083/product
 ...
 * @see /src/components/navigation/desktop/sidebar/subsidebars/ProductSidebar.vue
 */
        ...
        <div class="page-content is-relative">
          <div class="page-title has-text-centered">
            ...
            <div class="title-wrap">
              <h1 class="title is-4">Product and Package Page</h1>
            </div>
